	...
	<div class="row">
		<div class="col-8 col-content">
			<div class="tsd-panel tsd-typography">
				<h1 id="typedoc-md-theme">typedoc-md-theme</h1>
				<p>A simple markdown theme for typedoc.</p>
				<h2 id="credits">Credits</h2>
				<p>This theme is based on a similar theme by kimamula:
					<a href="https://github.com/kimamula/typedoc-markdown-theme">typedoc-markdown-theme</a>
					I only developed this one because the original seems to be a bit out of date, and because
				I want to customize it for my own needs.</p>
			</div>
		</div>
